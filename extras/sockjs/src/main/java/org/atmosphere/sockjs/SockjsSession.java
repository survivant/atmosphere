...
public interface SockjsSession {
     ...
     * @return
     */
    SockjsSessionOutbound getTransportHandler();
     ...
     */
    void onConnect(AtmosphereResourceImpl resource, SockjsSessionOutbound handler);
     ...
     * @param message
     */
    void onMessage(AtmosphereResourceImpl resource, SockjsSessionOutbound handler, String message);
