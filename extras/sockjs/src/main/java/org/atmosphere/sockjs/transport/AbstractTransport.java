...
public abstract class AbstractTransport implements Transport {
    ...
    public static void setCORS(AtmosphereRequest request, AtmosphereResponse response) {
  	  	String origin = null; //request.getHeader("origin"); 
        ...
        if ("GET".equals(request.getMethod())) {
            ...
            try {
                ...
                if (data != null && data.length() > 0) {
                    ...
                    if (!list.isEmpty()) {
                    	/*
                        if (SockjsPacketImpl.PacketType.DISCONNECT.equals(list.get(0).getFrameType())) {
                            return true;
                        }
                        */
                    }
